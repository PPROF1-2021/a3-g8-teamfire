...
$query = mysqli_query($conex,"SELECT * FROM REGISTRADOS WHERE usuario = '".$nombre."' and contrasena = '".$pass."'");
$nr = mysqli_num_rows($query);

if($nr == 1)
{
	print "<p><b> Bienvenido: $nombre </b></p>\n" ;
...
else if ($nr == 0) 
{
	...
	//echo "No ingreso"; 
	print "<p><b>Registro Invalido </b></p>\n";
}
